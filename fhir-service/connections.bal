...
configurable DatabaseConfig paDatabaseConfig = ?;

final mysql:Client dbClient = check new (
    host = paDatabaseConfig.host,
    port = paDatabaseConfig.port,
    user = paDatabaseConfig.user,
    password = paDatabaseConfig.password,
    database = paDatabaseConfig.database
);
