...
Pull the template from central
    ...
    ` bal new -t healthcare/health.fhir.r4.uscore700.organization OrganizationAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type Organization r4:Organization|<Other_Organization_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization", "new_profile_url"]`
