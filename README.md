...
|BulkExportClientFileServer|bulk-export-client/oas/FileServer.yaml| bulk-export-client file service endpoint [http://localhost:8100/file](http://localhost:8100/file) | Acts as the file server for bulk export client - client side                                                                                                                                                             |
