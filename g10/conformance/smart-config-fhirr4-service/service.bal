...
service /fhir/r4/\.well\-known on new http:Listener(9090) {
    ...
    resource isolated function get smart\-configuration() returns SmartConfigResponse|SmartConfigInternalServerError {
