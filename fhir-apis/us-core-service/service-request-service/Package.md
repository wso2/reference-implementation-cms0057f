...
| Profile URL          |[http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest](http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/health.fhir.r4.uscore700.servicerequest ServiceRequestAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type ServiceRequest r4:ServiceRequest|<Other_ServiceRequest_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest", "new_profile_url"]`
