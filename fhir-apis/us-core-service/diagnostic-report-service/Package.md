...
| Profile URL          |[http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/health.fhir.r4.uscore700.diagnosticreport DiagnosticReportAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type DiagnosticReport r4:DiagnosticReport|<Other_DiagnosticReport_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab", "new_profile_url"]`
