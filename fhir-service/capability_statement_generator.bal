    ...
    if configResources.length() > 0 {
        foreach ConfigResource configResource in configResources {
            ...
            do {
                ...
                international401:CapabilityStatementRestResourceSearchParam[] stringSearchParams = check populateSearchParams(configStringParams, international401:CODE_TYPE_STRING);
