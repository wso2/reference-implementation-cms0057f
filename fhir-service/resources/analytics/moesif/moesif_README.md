...
3. Import the ```module-ballerinax-health.fhir.r4/fhirr4/ballerina/src/main/resources/fhirservice/resources/analytics/moesif/moesif-cms-dashboard-template.json``` to Moesif.
