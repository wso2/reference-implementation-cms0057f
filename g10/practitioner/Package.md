...
| Profile URL          |[http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner](http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/health.fhir.r4.uscore311.practitioner PractitionerAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type Practitioner r4:Practitioner|<Other_Practitioner_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner", "new_profile_url"]`
