...
| Profile URL          |[http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest](http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/health.fhir.r4.uscore700.medicationrequest MedicationRequestAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type MedicationRequest r4:MedicationRequest|<Other_MedicationRequest_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest", "new_profile_url"]`
